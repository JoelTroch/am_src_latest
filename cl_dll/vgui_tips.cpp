...
#define TIPS_BASE_HEIGHT	(YRES(330))
#define TIPS_XSTEP			(XRES(20))
*/
#define TIPS_APPEAR_TIME		0.15
#define TIPS_DISAPPEAR_TIME		2

#define TIPS_BASE_HEIGHT	(YRES(400))
#define TIPS_XSTEP			(XRES(10))
...
//	gEngfuncs.Con_Printf("loaded\n");
	...
	m_pText->setText(TextWithoutFontName(pText));
