...
cvar_t	*cl_lazy_weapon;
cvar_t	*cl_hud_mode;
cvar_t	*cl_noise;
cvar_t	*origin_x;
cvar_t	*origin_y;
cvar_t	*origin_z;
cvar_t	*gl_shadowsize;
cvar_t *buildcubemap;
cvar_t *cv_cubemap;
cvar_t *r_rainmode;
cvar_t *r_fogmode;
...
//	RecClKeyEvent(down, keynum, pszCurrentBinding);
	if (gGui)
	{
		gGui->keyEvent(keynum, down, (char*)pszCurrentBinding);
	}
...
void InitInput (void)
{
	...
	gEngfuncs.pfnRegisterVariable("cl_lefthand", "0", FCVAR_ARCHIVE);
	...
	buildcubemap = gEngfuncs.pfnRegisterVariable("buildcubemap", "0", 0);
	cv_cubemap = gEngfuncs.pfnRegisterVariable("gl_cubemap", "2", FCVAR_ARCHIVE);

	cl_vsmoothing		= gEngfuncs.pfnRegisterVariable ( "cl_vsmoothing", "0.05", FCVAR_ARCHIVE );
	cl_lazy_weapon = gEngfuncs.pfnRegisterVariable("cl_lazy_weapon", "0.1", FCVAR_ARCHIVE);
	ak_test = gEngfuncs.pfnRegisterVariable("ak_test", "0", FCVAR_ARCHIVE);
	
	cl_hud_mode = gEngfuncs.pfnRegisterVariable("cl_hud_mode", "0", FCVAR_ARCHIVE);
	
	cl_noise			= gEngfuncs.pfnRegisterVariable("cl_noise", "1", FCVAR_ARCHIVE);
	origin_x			= gEngfuncs.pfnRegisterVariable("origin_x", "0.0", FCVAR_ARCHIVE);
	origin_y			= gEngfuncs.pfnRegisterVariable("origin_y", "0.0", FCVAR_ARCHIVE);
	origin_z			= gEngfuncs.pfnRegisterVariable("origin_z", "0.0", FCVAR_ARCHIVE);
	gl_shadowsize		= gEngfuncs.pfnRegisterVariable("gl_shadowsize", "512", FCVAR_ARCHIVE);
	...
	//r_rainmode
	/* 
	0 - disable modern rain and raindrops
	1 - only new rain
	2 - new rain and raindrops
	3 - only new raindrops*/
	r_rainmode = gEngfuncs.pfnRegisterVariable("r_rainmode", "2", FCVAR_ARCHIVE);
//	r_fogmode = gEngfuncs.pfnRegisterVariable("r_fogmode", "1", FCVAR_ARCHIVE);
	r_fogmode = gEngfuncs.pfnRegisterVariable("r_fogmode", "2", FCVAR_ARCHIVE);//SYS: fog mode 2 makes the sky visible, which is great!

	r_bloom = gEngfuncs.pfnRegisterVariable("r_bloom", "1", FCVAR_ARCHIVE);
	r_ssao = gEngfuncs.pfnRegisterVariable("r_ssao", "1", FCVAR_ARCHIVE);

	CVAR_CREATE("ccor", "1.0 1.0 1.0 1.0",FCVAR_CLIENTDLL);
