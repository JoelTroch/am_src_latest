...
void EMIT_SOUND_FMOD_2D_ONE(edict_t *tEntity, const char *cSample, float flPitch, bool bLookUpSubtitles) { }
...
const char *CBasePlayer::TeamID() { return "I HATE YOU, VOLVO"; }
