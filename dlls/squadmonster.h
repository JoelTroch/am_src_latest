...
// HUMAN SLOTS
#define bits_SLOT_HUMAN_ENGAGE1		( 1 << 0 )
#define bits_SLOT_HUMAN_ENGAGE2		( 1 << 1 )
#define bits_SLOTS_HUMAN_ENGAGE		( bits_SLOT_HUMAN_ENGAGE1 | bits_SLOT_HUMAN_ENGAGE2 )

#define bits_SLOT_HUMAN_GRENADE1	( 1 << 2 ) 
#define bits_SLOT_HUMAN_GRENADE2	( 1 << 3 ) 
#define bits_SLOTS_HUMAN_GRENADE	( bits_SLOT_HUMAN_GRENADE1 | bits_SLOT_HUMAN_GRENADE2 )
